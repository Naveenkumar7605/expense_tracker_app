...
export class DataShareService {
    ...
    async get_user_info() {
        ...
        transactions_info = transactions_info.sort((a:any,b:any)=>{
            let f_date:any= new Date(a.datetime)
            let b_date:any= new Date(b.datetime)
            return f_date - b_date
        })
        console.log(transactions_info,"transactions_info")
        return {
            contact,
            account_ids,
            transaction_ids,
