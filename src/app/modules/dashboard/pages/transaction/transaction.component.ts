...
export class TransactionComponent implements OnInit {
  ...
  constructor(private db: DataShareService, private api: ApiService, private dialog: MatDialog) { }
  ...
  ngOnInit(): void {
    ...
    this.db.get_user_info().then((res: any) => {
      ...
      // this.transaction_history = transactions_info.map((item: any) => {
      //   return {
      //     ...item,
  ...
  ngDoCheck() {
    ...
    let end_dt = DateTime.fromJSDate(this.form.controls['end_date'].value?._d).toFormat("yyyy-MM-dd");
    this.go_btn = true
    // console.log(this.form.controls['start_date'].touched)
